...
void SkyBoxCube::setMaterialBuffer()
{
...
SkyBoxCube::SkyBoxCube(float x, float y, float z, LPCWSTR texturePath, Camera* camera,
	ID3D11Device* device_ptr, ID3D11DeviceContext* device_context_ptr)
{
	...
	char* cubePath = new char[126]{ "SkyBoxCube.obj" };
...
void SkyBoxCube::setPosition(float x, float y, float z)
{
...
void SkyBoxCube::draw(ID3D11Buffer* light_constant_buffer, ID3D11Buffer* lightNr_constant_buffer,
